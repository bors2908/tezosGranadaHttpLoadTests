...
public class LoadTest {
    public static final int SLEEP = 10;  //If sleep is longer than 6000ms, second requests are OK
    public static final String HOST = "127.0.0.1";
    public static final int PORT = 11018;
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            HttpPost request = new HttpPost(
                "http://" + HOST + ":" + PORT + "/chains/main/blocks/head/helpers/forge/operations");
